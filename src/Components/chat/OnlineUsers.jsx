    ...
    <div className="h-full flex flex-col bg-dark-800 border-l border-slate-800">
          ...
          onlineUsers.map((u, i) => {
            ...
            return (
              <motion.div
                ...
                className="flex items-center gap-2.5 px-2.5 py-2 rounded-xl hover:bg-dark-700 transition-colors cursor-default"
              >
      ...
      <div className="px-4 py-3 border-t border-slate-800">
        <p className="text-[10px] text-slate-700 text-center leading-relaxed">
          Only users in the same room see each other's messages
        </p>
      </div>
    </div>
  );
